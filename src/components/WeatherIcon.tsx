...
export default function WeatherIcon(props: { state: string; nightTime?: boolean }) {
    const { state, nightTime } = props;
    return (
        <svg className="weather-icon" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg">
            <>
                {state === "sunny" && (
                    <path
                        className="sun"
